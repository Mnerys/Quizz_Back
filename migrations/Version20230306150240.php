 ...
 */
final class Version20230306150240 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE question ADD CONSTRAINT FK_B6F7494E5FB14BA7 FOREIGN KEY (level_id) REFERENCES theme (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
